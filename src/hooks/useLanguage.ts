...
export const translations = {
  es: {
    ...
    rsvp: {
      ...
      desc: "Por favor, infórmanos de tu asistencia antes del 5 de agosto de 2026 para coordinar cada detalle de la recepción.",
  ...
  en: {
    ...
    rsvp: {
      ...
      desc: "Please let us know if you are coming before August 5, 2026 to coordinate every single detail of the reception.",
